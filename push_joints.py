...
def push_pose_ui():
    ...
    input_joint_field  = cmds.textFieldGrp(label="Input Joint:", cw2=(140, 260))
    cons_joint1_field  = cmds.textFieldGrp(label="Constraint Joint 1:", cw2=(140, 260))
    cons_joint2_field  = cmds.textFieldGrp(label="Constraint Joint 2:", cw2=(140, 260))
    ...
    input_for_pose     = cmds.textFieldGrp(label="Input Joint (driver):", cw2=(140, 260))
